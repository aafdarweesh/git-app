<template>
    ...
    <div>
        ...
        <a-pagination v-model="page_number" v-on:change="requester" :total="500" show-less-items />
    </div>    
</template>
...
export default {
  ...
  methods: {
      requester: function() {
            var api = "https://api.github.com/repos/facebook/react/commits?page=" + this.page_number.toString();
            // console.log(api);
